           ...
           @foreach ($userData as $user)
               <tr>
                ...
                <td>
                  ...
                  <a>
                    <button class="btn btn-sm bg-danger text-white" disabled><i class="fas fa-ban"></i></button>
                  </a>
                  @else
                  <a href="{{ route('admin#delete', $user->id)}}">
                    <button class="btn btn-sm bg-danger text-white"></i><i class="fas fa-trash-alt"></i></button>
                  </a>
                  @endif
                  </td>
               </tr>
